...
import study.cc15.test.activities.PlaceActivity2;
import study.cc15.test.datastructures.Place;

public class PlacesRecViewAdapter2 extends RecyclerView.Adapter<PlacesRecViewAdapter2.ViewHolder>{

    private Context context;

    private ArrayList<Place> places = new ArrayList<>();

    public PlacesRecViewAdapter2(Context context) {
...
//                Toast.makeText(context, contacts.get(position).getName() + " Selected", Toast.LENGTH_SHORT).show();
                ...
                intent.putExtra("endPoint", places.get(position));
